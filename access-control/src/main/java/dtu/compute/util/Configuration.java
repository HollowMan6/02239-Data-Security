...
public class Configuration {
    ...
    public static final String[] testACUser = {"Alice", "Bob", "Cecilia", "David", "Erica", "Fred", "George"};
    public static final int[] testACList = {0b111111111, 0b000111111, 0b111001000, 0b110000000, 0b110000000, 0b110000000, 0b110000000};
    public static final String[] testUserRole = {"boss", "staff&tech", "vip", "user", "user", "user", "user"};
}
