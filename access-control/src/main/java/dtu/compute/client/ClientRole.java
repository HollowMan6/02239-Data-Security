...
public class ClientRole {
    ...
    public static void main(String[] args) throws MalformedURLException, NotBoundException, RemoteException {
        ...
        /* Test for Role Based Control */
        String testUserHashedPw = Crypto.hash(Configuration.testUserPassword);
        String[] acTestUsers = Configuration.testACUser;
        String[] userRoles = Configuration.testUserRole;
        for (int i = 0; i < acTestUsers.length; i++) {
            user.addUser(acTestUsers[i], Crypto.salt(testUserHashedPw), userRoles[i]);
        }
